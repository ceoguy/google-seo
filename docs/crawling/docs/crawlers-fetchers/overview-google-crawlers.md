...
# Overview of Google crawlers and fetchers (user agents)
 ...
 [automatically discover and scan websites](https://developers.google.com/search/docs/fundamentals/how-search-works#crawling).
...
### File size limits
 ...
 [like Googlebot](https://developers.google.com/search/docs/crawling-indexing/googlebot) may
...
### Crawl rate and host load
 ...
 [reduce the crawl rate](https://developers.google.com/crawling/docs/crawlers-fetchers/reduce-crawl-rate). Note that
 sending the inappropriate
 [HTTP response code](https://developers.google.com/search/docs/crawling-indexing/http-network-errors)
...
- 
 ...
 [verify Google's crawlers and fetchers](https://developers.google.com/crawling/docs/crawlers-fetchers/verify-google-requests).
