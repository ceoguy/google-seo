...
- 
 ...
 [RSS, mRSS, and Atom 1.0](https://developers.google.com#rss) | 
...
- Can be cumbersome to work with.
 ...
 [Text sitemap](https://developers.google.com#text) | 
...
## Sitemap best practices
 ...
 unless you submit your sitemap through [Search Console](https://developers.google.com#addsitemap), a sitemap
...
- 
 [Let your CMS generate a sitemap for you](https://developers.google.com#cmssitemap).
 
 
- 
 For sitemaps with less than a few dozen URLs,
 you can [manually create a sitemap](https://developers.google.com#manualsitemap).
 
 
- 
 For sitemaps with more than a few dozen URLs,
 [automatically generate a sitemap](https://developers.google.com#autositemap).
...
### Manually create a sitemap
 ...
 and follow a syntax described in the [Sitemap Formats](https://developers.google.com#sitemapformat) section. You
...
### Automatically generate a sitemap with tools
 ...
 Google. Note the
 [size requirements for sitemaps](https://developers.google.com#general-guidelines); if the sitemap becomes too
...
- 
 [Create a sitemap](https://developers.google.com#createsitemap) (or more if you prefer) that includes URLs
...
- 
 [Create one or more sitemaps](https://developers.google.com#createsitemap) for each individual site. For each
