...
- 
 [Redirects](https://developers.google.com#redirects-method): A strong signal that the target
 of the redirect should become canonical.
 
 
- 
 [`rel="canonical"` `link` annotations](https://developers.google.com#rel-canonical-link-method):
 A strong signal that the specified URL should become canonical.
 
 
- 
 [Sitemap inclusion](https://developers.google.com#sitemap-method): A weak signal that helps
...
- 
 ...
 [Google generally doesn't support URL fragments](https://developers.google.com/search/docs/crawling-indexing/url-structure#fragments).
 
 
- 
 We don't recommend using
 [`noindex`](https://developers.google.com/search/docs/crawling-indexing/block-indexing) to prevent
...
- 
 If you're using
 [`hreflang` elements](https://developers.google.com/search/docs/specialty/international/localized-versions),
...
## Comparison of canonicalization methods
 ...
 Add a `<link>` element in the code for all duplicate pages,
...
- 
 ...
 [`rel="canonical"` HTTP header](https://developers.google.com#rel-canonical-header-method)
 | 
...
- 
 ...
 [Sitemap](https://developers.google.com#sitemap-method) | 
...
- 
 [The `rel="canonical"` `link` element in the HTML](https://developers.google.com#rel-canonical-link-method)
 
 
- 
 [The `rel="canonical"` `link` HTTP header](https://developers.google.com#rel-canonical-header-method)
...
- 
 ...
 [`hreflang` annotations](https://developers.google.com/search/docs/specialty/international/localized-versions)
