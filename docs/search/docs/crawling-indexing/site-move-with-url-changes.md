...
- 
 [General best practices for site moves](https://developers.google.com/search/docs/crawling-indexing/site-move-with-url-changes#general_recommendations_for_site_moves).
...
- [Prepare the new site](https://developers.google.com#prepare-new-site) and test it thoroughly.
 
- 
 [Prepare a URL mapping](https://developers.google.com#prepare-url-mapping) from the current URLs to
 their corresponding new format.
 
- 
 [Start the site move](https://developers.google.com#start-site-move) by configuring the server to
 redirect from the old URLs to the new ones.
 
- [Monitor the traffic](https://developers.google.com#monitor) on both the old and new URLs.
...
- 
 ...
 [Submitting a sitemap](https://developers.google.com/search/docs/crawling-indexing/sitemaps/build-sitemap) can
...
- 
 ...
 `301` and
 [other permanent redirects](https://developers.google.com/search/docs/crawling-indexing/301-redirects#permanent-server-side-redirects)
...
- 
 Look in your [sitemaps](https://developers.google.com/search/docs/crawling-indexing/sitemaps/overview)
...
- 
 ...
 [`rel="canonical" <link>`](https://developers.google.com/search/docs/crawling-indexing/consolidate-duplicate-urls) tag.
...
### Plan your redirect strategy
 ...
 [permanent redirects](https://developers.google.com/search/docs/crawling-indexing/301-redirects)
...
Decide how you will move your site &ndash; all at once, or in sections:
...
- 
 ...
 supports
 [several kinds of redirects](https://developers.google.com/search/docs/crawling-indexing/301-redirects), we
...
- 
 ...
 [follow up to 10 hops](https://developers.google.com/crawling/docs/troubleshooting/http-status-codes#3xx-redirection)
...
- 
 ...
 [`soft 404` error](https://developers.google.com/search/docs/crawling-indexing/troubleshoot-crawling-errors#soft-404-errors).
...
## More resources
 ...
 [our help page](https://developers.google.com/search/help) and specific cases answered in
 our
 ...
 during our
 [SEO office hours](https://developers.google.com/search/help/office-hours).
