...
title: "Debug Google Search Traffic Drops"
fetched: 2026-07-08
---
...
- [Small drop in position?](https://developers.google.com#small) For example, dropping from position 2 to 4.
 
- [Large drop in position?](https://developers.google.com#large) For example, dropping from position 4 to 29.
...
### Spam issues
 ...
 If you suspect a drop due to a spam violation, review our [spam policies](https://developers.google.com/search/docs/essentials/spam-policies)
...
### Site moves and migrations
 ...
 If you see a drop after moving and it's not recovering, check the [site move troubleshooting section](https://developers.google.com/search/docs/crawling-indexing/site-move-with-url-changes#troubleshooting)
...
## Analyze your Search traffic drop pattern
 ...
 If both impressions and clicks dropped, check the [list of the most common reasons](https://developers.google.com#main-causes) that
 could have caused it. If your impressions remain the same but your clicks drop, you might not be
 generating the best [page title](https://developers.google.com/search/docs/appearance/title-link)
 and [snippet](https://developers.google.com/search/docs/appearance/snippet) that you could, and so users don't
...
### Monitor your average position in search results
 ...
 [self-assessing your content](https://developers.google.com/search/docs/fundamentals/creating-helpful-content#self-assess)
...
## Investigate overall trends in your industry
 ...
 If you want to go the extra mile, you can [use Google Trends](https://developers.google.com/search/docs/monitor-debug/trends-start)
