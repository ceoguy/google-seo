...
Sometimes embedded social engineering content will be visible to users on the host page, as
 shown in the [examples](https://developers.google.com#example). In other cases, the host site does not contain
...
If your site is flagged for containing social engineering (deceptive content), ensure that
 your page doesn't engage in any of the [practices](https://developers.google.com#examples), and then follow these steps:
...
- 
 Remove deceptive content. Ensure that none of your site's pages contain
...
- 
 Check the third-party resources included in your site. Ensure that any ads, images, or
...
- Follow the [third-party service guidelines](https://developers.google.com#third-party-guidelines) for any third-party services,
...
- 
 Request a review. After you remove all social engineering content from your site, you can
 [request a security review](https://support.google.com/webmasters/answer/9044101#fix)
