...
- If your site is using the [robots exclusion protocol](https://www.rfc-editor.org/rfc/rfc9309.html),
 ...
 across locales. This means that [robots `meta` tags](https://developers.google.com/search/docs/crawling-indexing/robots-meta-tag)
 and the [robots.txt file](https://developers.google.com/search/docs/crawling-indexing/robots/create-robots-txt) must
