...
title: "SEO Guidelines for Explicit Content"
fetched: 2026-07-08
---
...
# Guidelines for sites with explicit content
 ...
 Is your site being incorrectly flagged as explicit? Check our [troubleshooting guide](https://developers.google.com/search/docs/specialty/explicit/troubleshooting)
...
- Explicit personal information removals: We demote all pages from sites that receive a
 ...
 For more information on our ranking systems, check out our [removal-based demotion systems](https://developers.google.com/search/docs/appearance/ranking-systems-guide#removals)
 and [spam policies](https://developers.google.com/search/docs/essentials/spam-policies#other-behaviors-that-can-lead-to-demotion-or-removal).
...
- [Prevent user-generated harmful content on your platform](https://developers.google.com#prevent-user-generated-harmful-content).
 
- [Allow Google to fetch your video content files](https://developers.google.com#allow-google-to-fetch).
 
- [Allow Googlebot to crawl without age gate](https://developers.google.com#allow-googlebot-to-crawl).
 
- [Group explicit pages in a separate domain or subdomain](https://developers.google.com#group-explicit-pages).
 
- [Mark specific pages as explicit with metadata](https://developers.google.com#mark-specific-pages).
...
### Allow Google to fetch your video content files
 ...
 Allowing Googlebot to [fetch your video files](https://developers.google.com/search/docs/appearance/video#allow-fetch)
 ...
 requests to your server [really are from Google](https://developers.google.com/search/docs/crawling-indexing/verifying-googlebot).
...
### Allow Googlebot to crawl without age gate
 ...
 [verifying Googlebot requests](https://developers.google.com/search/docs/crawling-indexing/verifying-googlebot) and
...
- [Add metadata to pages with explicit content](https://developers.google.com#add-metadata).
 
- [Use the `<video:family_friendly>` tag in your video sitemap](https://developers.google.com#use-video-family-friendly-tag).

#### Add metadata to pages with sexually explicit content

 To mark a particular page as explicit, add [rating markup](https://developers.google.com/search/docs/crawling-indexing/special-tags#rating)
...
#### Use the `<video:family_friendly>` tag in your video sitemap
 ...
 tag in your video sitemap](https://developers.google.com/search/docs/crawling-indexing/sitemaps/video-sitemaps#family-friendly). You only need to use this tag (set to `no`) for
