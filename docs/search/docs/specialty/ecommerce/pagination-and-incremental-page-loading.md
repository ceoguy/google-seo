...
- 
 ...
 (Learn more about
 [infinite scroll search-friendly recommendations](https://developers.google.com/search/docs/crawling-indexing/javascript/lazy-loading#paginated-infinite-scroll).)
...
## How Google indexes the different strategies
 ...
 [JavaScript SEO best practices](https://developers.google.com/search/docs/crawling-indexing/javascript/javascript-seo-basics).
...
- 
 [Link pages sequentially](https://developers.google.com#sequentially)
 
 
- 
 [Use URLs correctly](https://developers.google.com#use-urls-correctly)
 
 
- 
 [Avoid indexing URLs with filters or alternative sort orders](https://developers.google.com#avoid-indexing-variations)
...
### Avoid indexing URLs with filters or alternative sort orders
 ...
 [URL patterns with a robots.txt file](https://developers.google.com/search/docs/crawling-indexing/robots/robots_txt#url-matching-based-on-path-values).
