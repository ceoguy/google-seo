...
title: "How To Launch an Ecommerce Site on Google"
fetched: 2026-07-08
---
...
- 
 [Verify your site ownership with Google](https://support.google.com/webmasters/answer/9008080).
 
 
- 
 [Ask Google to index your site](https://developers.google.com/search/docs/crawling-indexing/ask-google-to-recrawl):
...
- 
 ...
 Provide a [sitemap](https://developers.google.com/search/docs/crawling-indexing/sitemaps/build-sitemap).
...
- 
 [Track how Google Search is indexing your site](https://support.google.com/webmasters/answer/7440203).
...
- 
 [Grand reveal](https://developers.google.com#grand-reveal):
 Make your entire site live to the public and Google at the same time.
 
 
- 
 [Home page launch](https://developers.google.com#home page-launch):
 Initially make only the home page of the site available to the public and Google.
 
 
- 
 [Launch without product availability](https://developers.google.com#products-unavailable):
 Launch the full site to the public and Google, with products marked as "out of stock".
 
 
- 
 [Soft launch](https://developers.google.com#soft-launch):
...
## Grand reveal
 ...
 [launching an ecommerce site](https://developers.google.com#steps).
...
## Home page launch
 ...
 [rest of the steps](https://developers.google.com#steps)
...
## Launch without product availability
 ...
 Actions:
 [Do all of the steps to launching your ecommerce site](https://developers.google.com#steps), but provide product
...
## Soft Launch
 ...
 Actions:
 [Do all of the steps to launching an ecommerce site](https://developers.google.com#steps) as soon as the site goes live.
