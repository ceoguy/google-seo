...
#### `BreadcrumbList`
 ...
 [breadcrumb markup documentation](https://developers.google.com/search/docs/appearance/structured-data/breadcrumb).
...
- 
 Register
 [your physical store locations and store codes](https://support.google.com/business/answer/4542487)
 for use by Google Merchant Center.
 
 
- 
 Follow the
 [Merchant Center guidelines](https://support.google.com/merchants/answer/6363310)
...
#### `Organization`
 ...
 [`Organization` structured data documentation](https://developers.google.com/search/docs/appearance/structured-data/organization).
...
#### `Product`
 ...
 (and [product variants](https://developers.google.com/search/docs/appearance/structured-data/product-variants),
...
#### `VideoObject`
 ...
 [video schema markup documentation](https://developers.google.com/search/docs/appearance/structured-data/video)
