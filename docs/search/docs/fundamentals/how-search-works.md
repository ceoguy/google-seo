...
- 
 [Crawling:](https://developers.google.com#crawling) Google downloads text, images, and videos
 from pages it found on the internet with automated programs called crawlers.
 
 
- 
 [Indexing:](https://developers.google.com#indexing) Google analyzes the text, images, and
 video files on the page, and stores the information in the Google index, which is a large
 database.
 
 
- 
 [Serving search results:](https://developers.google.com#serving) When a user searches on
