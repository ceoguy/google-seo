...
| Attach metadata | Make sure that your Web Stories follow the AMP story metadata guidelines . Include markup that you would normally include on a web page, such as: `title` and `description` `meta` tags Structured data OGP Twitter card |
