...
# Best practices for creating Web Stories
 ...
 [Web Stories](https://developers.google.com/search/docs/appearance/enable-web-stories). We recommend
...
## SEO
 ...
 Note: The same
 [SEO
 best practices](https://developers.google.com/search/docs/fundamentals/seo-starter-guide) for web pages also apply to [Web
 Stories](https://developers.google.com/search/docs/appearance/enable-web-stories). A Web Story is still a web page.
 ...
 [storytelling
 best practices](https://developers.google.com#storytelling) to keep your readers engaged.
 | 
 ...
 Coverage Report](https://support.google.com/webmasters/answer/7440203) and [Sitemaps
 Report](https://support.google.com/webmasters/answer/7451001) in Search Console.
 | 
 ...
 Note: If there are multiple versions of the same story in different languages, make sure to [tell Google about localized versions](https://developers.google.com/search/docs/specialty/international/localized-versions).
...
### More SEO best practices
 ...
 We recommend [including structured data](https://developers.google.com/search/docs/appearance/structured-data/article#amp-sd)
 ...
 [AMP
 story page attachments](https://amp.dev/documentation/components/amp-story-page-attachment/) can be used to present additional information alongside your Web
 ...
 Add [captions
 to your video](https://developer.mozilla.org/en-US/docs/Web/Guide/Audio_and_video_delivery/Adding_captions_and_subtitles_to_HTML5_video) to help readers better understand your story. Avoid captions that are
...
[AMP Validator tool](https://validator.ampproject.org/) and fix any detected errors.
 | 
...
- [Structured data guidelines](https://developers.google.com/search/docs/appearance/structured-data/sd-policies): Details on
 ...
 arrow_forward](https://developers.google.com/search/docs/appearance/web-stories-content-policy)
