...
# Control your snippets in search results
 ...
 [meta description](https://developers.google.com#meta-descriptions) element when it describes the page better than
...
While we can't manually change snippets for individual sites, we're always working
 ...
 displayed for your pages by following the [best practices for creating quality meta descriptions](https://developers.google.com#meta-descriptions).
...
## How snippets are created
 ...
 [meta description](https://developers.google.com#meta-descriptions) HTML element if it might give users a more
