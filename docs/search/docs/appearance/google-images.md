...
- [Help us discover and index your images](https://developers.google.com#discover-images)
 
- [Optimize the image landing pages](https://developers.google.com#optimize-landing-page)
...
- 
 If the request is coming from a Google domain, reply with a `200` HTTP status code,
