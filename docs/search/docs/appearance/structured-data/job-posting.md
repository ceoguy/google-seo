...
title: "Learn About Job Posting Schema Markup"
fetched: 2026-07-08
---
...
- Increased chances of discovery and conversion: Job seekers will have a
 ...
 Does your site provide reviews about other employers? Add [`EmployerAggregateRating` structured data](https://developers.google.com/search/docs/appearance/structured-data/employer-rating).
...
- If you have several copies of the same job posting on your site hosted under different
 URLs, [use canonical URLs](https://developers.google.com/search/docs/crawling-indexing/consolidate-duplicate-urls)
 on each copy of the page.
 
- Add the [required and recommended properties](https://developers.google.com#structured-data-type-definitions). Based on the
...
- Follow the [technical guidelines](https://developers.google.com#technical-guidelines) and [job posting content policies](https://developers.google.com#content-policies).
...
- Keep Google informed by using the Indexing API and submitting a sitemap.
 ...
 However, we still recommend [submitting a sitemap](https://developers.google.com/search/docs/crawling-indexing/sitemaps/overview)
...
- `[jobLocationType](https://developers.google.com#job-location-type)`: Use this property to
...
- `[jobLocation](https://developers.google.com#job-location)`: Use this property to specify where
...
## Update your company logo
 ...
 [using structured data](https://developers.google.com/search/docs/appearance/structured-data/organization#logo).
 ...
 for the organization. For more information, see [hiringOrganization](https://developers.google.com#hiring).
...
- The URLs in the sitemap must include
 [the canonical page](https://developers.google.com/search/docs/crawling-indexing/consolidate-duplicate-urls)
...
- Job titles, description, and other details that use [keyword stuffing](https://developers.google.com/search/docs/essentials/spam-policies#keyword-stuffing)
...
### Expired job postings
 ...
 [remove expired job postings](https://developers.google.com#remove-job-postings) from your website. If you
...
### Content doesn't match the structured data
 ...
 [job posting isn't representative](https://developers.google.com#misrepresentation) of the actual job.
 ...
 For a full list of examples, see the examples in [our content policies](https://developers.google.com#content-policies).
...
- Keep Google informed by using the [Indexing API](https://developers.google.com/search/apis/indexing-api).
 For job posting URLs, we recommend using the Indexing API instead of
 sitemaps because the Indexing API prompts Googlebot to crawl your page sooner than
 removing the URL from the sitemap. However, we still recommend
 [submitting a sitemap](https://developers.google.com/search/docs/crawling-indexing/sitemaps/overview)
...
### Logo is incorrect
 ...
 [Update your company logo](https://developers.google.com#company-logo).
...
- Make sure you specify the correct logo with the
 `[hiringOrganization.logo](https://developers.google.com#hiring)` property.
...
- [Suggest a change](https://support.google.com/posts/answer/7534842) to your
 ...
 add the `[hiringOrganization.logo](https://developers.google.com#hiring)` property.
