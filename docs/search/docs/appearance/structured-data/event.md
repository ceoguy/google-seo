...
title: "Learn About Google Event Schema Markup"
fetched: 2026-07-08
---
...
- Increased chances of discovery and conversion: People have a new way to
 ...
 [Eventbrite saw a 100% increase](https://developers.google.com/search/case-studies/eventbrite-case-study) in
...
- If you're comfortable editing your HTML, [use structured data to directly integrate](https://developers.google.com#add-structured-data)
...
### Event with an updated status
 ...
 There are multiple ways to set the status of an event. Here are some common examples of events that have an updated status. For more information, refer to the [`eventStatus`](https://developers.google.com#eventstatus) property.
...
- [Date and time guidelines](https://developers.google.com#date-time-best-guidelines)
...
### Date and time guidelines
 ...
 When implementing the [`startDate`](https://developers.google.com#startdate), [`endDate`](https://developers.google.com#enddate),
 and [`previousStartDate`](https://developers.google.com#previous-start-date) properties, follow these
 date and time guidelines.
...
```
 ...
 Warning: When the event status changes,
 DON'T remove the [`startDate`](https://developers.google.com#startdate). The `startDate`
...
- Post a question in the [Google Search Central forum](https://support.google.com/webmasters/community).
 ...
 and [review our guidelines](https://developers.google.com#guidelines). If
...
- Make sure the structured data includes values for `eventLocation`,
 `addressLocality`, or `addressRegion` (depending on the location,
 since not all of the location properties are applicable).
 
- Check that the `location.name` field uses the location name, or leave it blank
...
### My site isn't showing up as an option for
 ...
 `[offers.url](https://developers.google.com#offers-url)` property is missing or doesn't meet the
 [URL requirements](https://developers.google.com#url-requirements).
...
- Make sure that your structured data includes the
 `[offers.url](https://developers.google.com#offers-url)` property.
 
- Ensure that your URL meets the [URL requirements](https://developers.google.com#url-requirements) for
 `offers.url`.
 
- Ask Google to [recrawl your
 site](https://developers.google.com/search/docs/crawling-indexing/ask-google-to-recrawl).
 
- Submit a [request for (re)evaluation](https://docs.google.com/forms/d/e/1FAIpQLSeoRYNFmYPdoj81jJAl9wS_0RsU-y8b9rVjHgZ1hZzCFXJ8hw/viewform).
