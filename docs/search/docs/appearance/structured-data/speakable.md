...
title: "Speakable (BETA) Schema Markup"
fetched: 2026-07-08
---
...
- Make sure that you follow [our guidelines](https://developers.google.com#guidelines).
 
- Add [`speakable` structured data](https://developers.google.com#structured-data-type-definitions)
 to your web page.
