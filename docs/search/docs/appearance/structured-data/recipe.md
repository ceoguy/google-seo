...
### Carousel
 ...
 Here's an example of a recipe summary page (a page with a list of recipes) with `[itemList](https://developers.google.com#item-list)` structured data. This content may be eligible to be displayed in a grid in Search results.
...
## Guidelines
 ...
 guidelines](https://developers.google.com/search/docs/appearance/structured-data/sd-policies) for your markup to be eligible to appear in Search results.
...
- To enable your recipes to appear in a
 [carousel](https://developers.google.com/search/docs/appearance/structured-data/carousel) or grid, you must follow these
 guidelines:
...
### `ItemList`
 ...
 In addition to [Recipe properties](https://developers.google.com#recipe-properties), add the following properties for
