...
title: "Fact Check (ClaimReview) Markup for Search"
fetched: 2026-07-08
---
...
- If your website aggregates fact-check articles, ensure that all articles match the
 [criteria](https://developers.google.com#guidelines) and that you provide an open and publicly available list of all fact-check websites
 you aggregate.
...
- `[ClaimReview](https://developers.google.com#claimreview)`
 
- `[Claim](https://developers.google.com#claim)`
 
- `[Rating](https://developers.google.com#rating)`
...
### `Claim`
 ...
 `[Organization](https://schema.org/Organization)` or
