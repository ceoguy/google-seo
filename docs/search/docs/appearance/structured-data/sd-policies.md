...
- The structured data is not [representative of the main content of the page](https://developers.google.com#relevance),
 or is potentially misleading.
 
- The structured data is incorrect in a way that the Rich Results Test was not able
 to catch.
 
- The content referred to by the structured data is [hidden from the user](https://developers.google.com#hidden).
