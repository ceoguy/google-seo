...
title: "Book Schema for Google Search"
fetched: 2026-07-08
---
...
## Get started
 ...
 actions [structured data type definitions](https://developers.google.com#structured-data-type-definitions),
 but first review the following sections:

 
 
- [Guidelines](https://developers.google.com#guidelines)
 
- [Create your feed](https://developers.google.com#create-your-feed)
 
- [Test your feed with the Data
 Feed validation tool](https://developers.google.com#test-your-feed-with-the-data-feed-validation-tool)
 
- [Host your feed file](https://developers.google.com#host-your-feed-file)
 
- [Submit your feed file for review](https://developers.google.com#submit-your-feed-file-for-review)
 
- [Update your feed as needed](https://developers.google.com#update-your-feed-as-needed)
...
## Guidelines
 ...
 [general structured data guidelines](https://developers.google.com/search/docs/appearance/structured-data/sd-policies) and the
 [Search Essentials](https://developers.google.com/search/docs/essentials). The guidelines are as follows:

 
 
- [Works and editions](https://developers.google.com#works-and-editions)
 
- [Library systems and library members](https://developers.google.com#library-systems-and-library-members)
 
- [ISBN and other supported identifiers](https://developers.google.com#isbn-and-other-supported-identifiers)
 
- [Links](https://developers.google.com#links)
...
- Edition: A concrete copy of the book. Specifically, metadata such as the
 ...
 obvious. There are two [`Book` entities](https://developers.google.com#book-entity):

 
 
- [`Book` (`Work`)](https://developers.google.com#book-work) is the "top level" `Book`
 entity:
...
- [`Book` (`Edition`)](https://developers.google.com#book-edition) is the "lower level" `Book`
 entity.
...
### Library systems and library members
 ...
 The [`Library entity`](https://developers.google.com#library-entity) is
 the "top level" `Library` entity type. It's an abstract construct, which consists
 of a [`LibrarySystem`](https://developers.google.com#librarysystem) entity and each "lower level"
 [`Library (member)`](https://developers.google.com#library-member) entity of that library system.
...
- Group all of the [`Edition`](https://developers.google.com#book-edition) entities under the same
 [Work](https://developers.google.com#book-work), and ensure at least one of the editions has an ISBN, OCLC
...
- If you have duplicate pages for the same content, the link must be the
 [canonical URL](https://developers.google.com/search/docs/crawling-indexing/consolidate-duplicate-urls) that contains the book title and other book
 information.
...
## Create your feed
 ...
 [`Book`](https://developers.google.com#book-entity) feed. A Google support team will reach out to you
 ...
 [`Book`](https://developers.google.com#book-entity) feed and your
 [`Library`](https://developers.google.com#library-entity) feed. A Google support team will reach out
...
- If you have multiple feed files, you can upload them as is, or if you prefer, you can
 ...
 [sitemap index file](https://developers.google.com/search/docs/crawling-indexing/sitemaps/large-sitemaps).
...
### DataFeed entity
 ...
 [`Book`](https://developers.google.com#book-entity) and
 [`Library`](https://developers.google.com#library-entity) entities must be listed under the
...
```
 ...
 [Create your feed](https://developers.google.com#create-your-feed), if you have both a
 [`Book`](https://developers.google.com#book-entity) feed and a [`Library`](https://developers.google.com#library-entity)
...
#### `Book` (`Work`)
 ...
 Key Point: Read the
 [Works and editions](https://developers.google.com#works-and-editions) guidelines to understand the difference
