...
- [Help Google find your videos](https://developers.google.com#help-google-find)
 
- [Ensure your videos can be indexed](https://developers.google.com#indexing-criteria)
 
- [Enable specific video features](https://developers.google.com#enable-search-features)
 
- [Remove, restrict, or update your videos as needed](https://developers.google.com#remove)
 
- [Monitor your videos with Search Console](https://developers.google.com#monitor)
 
- [Troubleshoot video issues](https://developers.google.com#troubleshoot)
...
- If you're using JavaScript to inject the video, make sure that it
 [appears in the rendered HTML in the URL inspection tool](https://developers.google.com/search/docs/crawling-indexing/javascript/javascript-seo-basics).
...
- The [watch page](https://developers.google.com#watch-page) must be indexed.
...
- The video can't be hidden behind other elements.
 ...
 before seeing the video), add [paywall structured data](https://developers.google.com/search/docs/appearance/structured-data/paywalled-content)
 so that Google can still find and index the video.
 
 
 
- The video must have a [valid thumbnail](https://developers.google.com#valid-thumbnail) that's available at a
...
### Use stable URLs
 ...
 To make your videos [eligible for specific features](https://developers.google.com#enable-search-features) like key
...
It's fine to include the same video on both a watch page and another page
 ...
 still be eligible to appear as a [text result](https://developers.google.com/search/docs/appearance/visual-elements-gallery#text-result)
 and [Google Image result with a video badge](https://developers.google.com/search/docs/appearance/structured-data/video).
...
### Using third-party embedded players
 ...
 [video indexing criteria](https://developers.google.com#indexing-criteria).

 For your own watch page where you've embedded the third-party player, we still recommend that you
 [provide structured data](https://developers.google.com#structured-data), and you may
 ...
 [fetch your video file](https://developers.google.com#allow-fetch).
...
### Provide a high-quality video thumbnail
 ...
 [allow Google to fetch your video files](https://developers.google.com#allow-fetch), Google will try to
...
- For structured data, specify the `[thumbnailUrl`](https://developers.google.com/search/docs/appearance/structured-data/video#thumbnail-url)
 property.
...
Not all features are eligible to trigger on all queries. Google doesn't
 ...
 in our [general structured data guidelines](https://developers.google.com/search/docs/appearance/structured-data/sd-policies).
...
### Video previews
 ...
 [allow Google to fetch your video files](https://developers.google.com#allow-fetch). You can set the maximum
...
## Allow Google to fetch your video files
 ...
 [video previews](https://developers.google.com#video-previews) and [key moments](https://developers.google.com#key-moments).
...
- Allow Google to fetch the video's streaming file URL (such as M3U8). Don't block the URL of
 the actual video bytes with the [`noindex`](https://developers.google.com/search/docs/crawling-indexing/block-indexing)
 rule or [robots.txt](https://developers.google.com/search/docs/crawling-indexing/robots/intro) file.
 
 
- The video file must be available at a [stable URL](https://developers.google.com#stable-url).
 
- Use structured data to provide the [`contentURL`](https://developers.google.com/search/docs/appearance/structured-data/video#content-url)
 value of a [supported file type](https://developers.google.com#supported-video-files).
...
- The host of the video watch page and the server that's streaming the actual video must have
 ...
 [technical requirements for Google Search](https://developers.google.com/search/docs/essentials/technical) and
...
If you need your video removed from search results as quickly as possible,
 [file a removal request](https://developers.google.com/search/docs/crawling-indexing/remove-information) for the
...
- Indicate an expiration date in your structured data (the
 [`expires`](https://developers.google.com/search/docs/appearance/structured-data/video#expires)
